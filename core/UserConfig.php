...
class UserConfig
{
    ...
    */
    ...
    # e.g. const MESSAGE_ENVELOPE = 'listbounces@yourdomain';
    ...
    */
    ...
    ## you have works ok
    const PHPMAILER_USE_CUSTOM = false;
    ...
    const PHPMAILER_USE_SMTP = false;
    ...
    const PHPMAILER_USE_TESTHOST = false;
    const PHPMAILER_TESTHOST = '';
    const PHPMAILER_BLASTHOST = '';
    const PHPMAILER_BLASTPORT = 25;

    # to use SSL/TLS when sending set this value
    # it can either be 'ssl' or 'tls', nothing else
    const PHPMAILER_SECURE = '';

    ## Smtp Timeout
    ## If you use SMTP for sending, you can set the timeout of the SMTP connection
    ## defaults to 5 seconds
    const PHPMAILER_SMTP_TIMEOUT = 5;
