 ...
 */
final class Version20251028080125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX loginnameidx ON phplist_admin');
        $this->addSql('ALTER TABLE phplist_admin CHANGE modified modified TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, CHANGE privileges privileges LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE phplist_linktrack CHANGE latestclick latestclick DATETIME DEFAULT CURRENT_TIMESTAMP');
        ...
        $this->addSql('ALTER TABLE phplist_list DROP rssfeed, CHANGE description description VARCHAR(255) NOT NULL, CHANGE prefix prefix VARCHAR(255) NOT NULL, CHANGE modified modified DATETIME NOT NULL, CHANGE active active TINYINT(1) NOT NULL, CHANGE category category VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE phplist_user_blacklist_data CHANGE data data LONGTEXT DEFAULT NULL, ADD PRIMARY KEY (email)');
        $this->addSql('DROP INDEX foreignkey ON phplist_user_user');
        $this->addSql('DROP INDEX optidx ON phplist_user_user');
        $this->addSql('DROP INDEX uuididx ON phplist_user_user');
        $this->addSql('ALTER TABLE phplist_user_user DROP optedin, DROP uuid, DROP subscribepage, DROP rssfrequency, DROP password, DROP passwordchanged, DROP foreignkey, CHANGE confirmed confirmed TINYINT(1) NOT NULL, CHANGE blacklisted blacklisted TINYINT(1) NOT NULL, CHANGE bouncecount bouncecount INT NOT NULL, CHANGE modified modified DATETIME NOT NULL, CHANGE uniqid uniqid VARCHAR(255) NOT NULL, CHANGE htmlemail htmlemail TINYINT(1) NOT NULL, CHANGE disabled disabled TINYINT(1) NOT NULL, CHANGE extradata extradata LONGTEXT NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8A30188621D23BBC ON phplist_user_user (uniqid)');
        $this->addSql('ALTER TABLE phplist_user_user RENAME INDEX email TO UNIQ_8A301886E7927C74');
        ...
        $this->addSql('ALTER TABLE phplist_userstats CHANGE listid listid INT DEFAULT 0 NOT NULL, CHANGE value value INT DEFAULT 0 NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE phplist_admin CHANGE modified modified DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE privileges privileges TEXT DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX loginnameidx ON phplist_admin (loginname)');
        ...
        $this->addSql('ALTER TABLE phplist_userstats CHANGE listid listid INT DEFAULT 0, CHANGE value value INT DEFAULT 0');
    }
}
