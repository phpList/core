...
final class CreateMessageDto implements MessageDtoInterface
{
    ...
    public function getContent(): MessageContentDto { return $this->content; }
    public function getFormat(): MessageFormatDto { return $this->format; }
    public function getMetadata(): MessageMetadataDto { return $this->metadata; }
    public function getOptions(): MessageOptionsDto { return $this->options; }
    public function getSchedule(): MessageScheduleDto { return $this->schedule; }
